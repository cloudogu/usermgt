...
<mail>
    ...
    <message>{{ .Config.GetOrDefault "mail/import/message" "<![CDATA[<html><body><h2>Willkommen im Cloudogu Ecosystem!</h2><p>Dies ist Ihr Benutzeraccount:</p><p>Benutzername: ${username}</p><p>Passwort: ${password}</p><p>Bei der ersten Anmeldung müssen Sie das Passwort ändern.</p></body></html>]]>"}}</message>
